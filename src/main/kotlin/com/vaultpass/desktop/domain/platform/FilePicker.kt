...
interface FilePicker {
    ...
    /**
     * Prompts the user to select a folder (directory).
     *
     * @param title The title of the dialogue window.
     * @return The selected folder File, or null if the user canceled.
     */
    suspend fun showFolderPickerDialog(title: String): File?
}
